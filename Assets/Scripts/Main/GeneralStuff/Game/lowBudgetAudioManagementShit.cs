...
public class lowBudgetAudioManagementShit : MonoBehaviour
{
    ...
    public AudioManagerLiveReaction TpSource,SchoolMusic,EscapeMusic,EndingMusic,WarMusic,TimeoutMusic,GameOverSource,ChaosAudioSource,MainSource1,MainSource2,MainSource3,MainSource4,DIMCSource,ShuckSource,CranberrySodaSource,ItemHoldingSoundSource;
    ...
    public AudioObjectyeah schoolClip,WAR,timeoutMusicAud,MainLms,meowlLmsCra,meowlLmsLoop,meowlLmsOutro,shithourIntro,shithourLoop,fuckminuteIntro,fuckminuteLoop,TaldiEscape;
