...
public class ITM_shucks : BaseItem
{
    ...
    public override bool OnUse()
    {
        ...
        GameControllerScript.Instance.player.SetHP(PlayerScript.HealthChangeMode.Set, (int)GameControllerScript.Instance.player.maxHealth/2f, 6f, false, true, false);
